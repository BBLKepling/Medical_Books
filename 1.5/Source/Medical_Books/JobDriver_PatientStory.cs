    ...
    public class JobDriver_PatientStory : JobDriver
    {
        ...
        protected Toil ReadToil(int duration)
        {
            ...
            toil.initAction = delegate
            {
                ...
                Job newjob = JobMaker.MakeJob(MedicalBooksDefOf.BBLK_Job_PatientListen, Bed, pawn);
            ...
            toil.tickAction = delegate
            {
                ...
                {
                    pawn.interactions.TryInteractWith(Patient, MedicalBooksDefOf.BBLK_PatientStory);
                }
            ...
            toil.AddFinishAction(delegate
            {
                ...
                TaleRecorder.RecordTale(MedicalBooksDefOf.BBLK_PatientStory_Tale, pawn, Patient, Book);
            });
            return toil;
        }
